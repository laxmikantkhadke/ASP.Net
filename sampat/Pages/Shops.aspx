<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shops.aspx.cs" Inherits="Pages_Shops" %>
...
<body>
    ...
    <center>
        <div id="main" style="width: 960px">
            <div id="header">
                ...
                <div id="ContactUs" style="float: right">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    <a href="ContactUs.aspx" style="text-decoration: none">Submit Requirement</a>
                </div>
            </div>
        ...
        <div id="Shopsdata">
            <h1>
                Commercial Property (Shops / Offices) for Rent</h1>
...
<ControlStyle Height="150px" Width="250px"></ControlStyle>
            ...
            <asp:Label ID="Label1" runat="server" style="text-align: left" Text="Label" 
                Visible="False"></asp:Label>
            <asp:Label ID="Label2" runat="server" style="text-align: left" Text="Labe2" 
                Visible="False"></asp:Label>
        </div>
    </center>
    </form>
