<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LandForSale.aspx.cs" Inherits="Pages_LandForSale" %>
        ...
        <div id="LandForSaledata">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Rent" HeaderText="Sale Price (Rs)" />
