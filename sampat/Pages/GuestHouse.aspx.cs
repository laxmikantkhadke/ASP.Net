...
public partial class Pages_GuestHouse : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            SqlDataAdapter da = new SqlDataAdapter("select * from gh", con);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            con.Open();
            cmd = new SqlCommand("insert into gh (Location,Area,Rent,Mobile,Details,Image) values(@Location,@Area,@Rent,@Mobile,@Details,@Image)", con);
            ...
            Response.Redirect("GuestHouse.aspx");
        }
        catch (Exception ex)
        {
            // Button1.Text = ex.Message;
