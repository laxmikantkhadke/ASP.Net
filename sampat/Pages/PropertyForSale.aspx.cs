...
public partial class Pages_PropertyForSale : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            con.Open();
            cmd = new SqlCommand("insert into property (Location,Area,Rent,Mobile,Details,Image) values(@Location,@Area,@Rent,@Mobile,@Details,@Image)", con);
            ...
            Response.Redirect("PropertyForSale.aspx");
        }
        catch (Exception ex)
        {
            // Button1.Text = ex.Message;
