...
public partial class Pages_Hostel : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            con.Open();
            cmd = new SqlCommand("insert into hostel (Location,Area,Rent,Mobile,Details,Image) values(@Location,@Area,@Rent,@Mobile,@Details,@Image)", con);
