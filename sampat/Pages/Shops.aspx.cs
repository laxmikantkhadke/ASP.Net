...
public partial class Pages_Shops : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
            ...
            try
            {
                SqlDataAdapter da = new SqlDataAdapter("select * from commercial", con);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            con.Open();
            cmd = new SqlCommand("insert into commercial (Location,Area,Rent,Mobile,Details,Image) values(@Location,@Area,@Rent,@Mobile,@Details,@Image)", con);
